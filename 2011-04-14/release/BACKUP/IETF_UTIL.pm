...
require Exporter;
@ISA = qw(Exporter);
@EXPORT = qw(rm_tr rm_hd my_defined convert_date get_current_date get_current_time clear_screen format_textarea unformat_textarea indent_text indent_text2 validate_date reduce_text add_spaces);
