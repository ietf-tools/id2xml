...
my $text_val = db_select("select future_meeting from meetings where meeting_num=$meeting_num");
open OUT,">$TARGET_DIR/fm.html";
print OUT qq{<HTML>
<HEAD>
<TITLE></TITLE>
</HEAD>
...
<h2>1.$section_num Future IETF Meeting Sites</h2>
<pre>
$text_val
</pre>
</BODY></HTML>
