...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'liaisons_liaisonstatement', 'cc', 'cc_contacts')
        db.rename_column(u'liaisons_liaisonstatement', 'technical_contact', 'technical_contacts')
        db.rename_column(u'liaisons_liaisonstatement', 'response_contact', 'response_contacts')
        db.rename_column(u'liaisons_liaisonstatement', 'to_contact', 'to_contacts')

        # Adding field 'LiaisonStatement.action_holder_contacts'
        db.add_column(u'liaisons_liaisonstatement', 'action_holder_contacts',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        db.rename_column(u'liaisons_liaisonstatement', 'cc_contacts', 'cc')
        db.rename_column(u'liaisons_liaisonstatement', 'technical_contacts', 'technical_contact')
        db.rename_column(u'liaisons_liaisonstatement', 'response_contacts', 'response_contact')
        db.rename_column(u'liaisons_liaisonstatement', 'to_contacts', 'to_contact')

        # Deleting field 'LiaisonStatement.action_holder_contacts'
        db.delete_column(u'liaisons_liaisonstatement', 'action_holder_contacts')
