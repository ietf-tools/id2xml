...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ipr_nondocspecificiprdisclosure', (
            ...
            ('holder_contact_info', self.gf('django.db.models.fields.TextField')()),
        ...
        db.create_table(u'ipr_holderiprdisclosure', (
            ...
            ('holder_contact_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('holder_contact_info', self.gf('django.db.models.fields.TextField')()),
            ('licensing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ipr.IprLicenseTypeName'])),
        ...
        db.create_table(u'ipr_iprdisclosurebase', (
            ...
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ipr.IprDisclosureStateName'])),
        ...
        db.create_table(u'ipr_iprevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ipr.IprEventTypeName'])),
            ('by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'])),
            ('disclosure', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ipr.IprDisclosureBase'])),
            ('desc', self.gf('django.db.models.fields.TextField')()),
            ('msg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['message.Message'], null=True, blank=True)),
        ))
        db.send_create_signal(u'ipr', ['IprEvent'])

        # Adding model 'IprDisclosureStateName'
        db.create_table(u'ipr_iprdisclosurestatename', (
        ...
        db.send_create_signal(u'ipr', ['IprDisclosureStateName'])
        ...
        db.create_table(u'ipr_iprdocrel', (
            ...
            ('revisions', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        ...
        db.create_table(u'ipr_ipreventtypename', (
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'ipr', ['IprEventTypeName'])

        # Adding model 'IprLicenseTypeName'
        db.create_table(u'ipr_iprlicensetypename', (
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('desc', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'ipr', ['IprLicenseTypeName'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ipr_iprdisclosurestatename')
        ...
        db.delete_table(u'ipr_ipreventtypename')

        # Deleting model 'IprLicenseTypeName'
        db.delete_table(u'ipr_iprlicensetypename')
    ...
    models = {
        ...
        u'ipr.genericiprdisclosure': {
            ...
            'holder_contact_info': ('django.db.models.fields.TextField', [], {}),
        ...
        u'ipr.holderiprdisclosure': {
            ...
            u'iprdisclosurebase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['ipr.IprDisclosureBase']", 'unique': 'True', 'primary_key': 'True'}),
            'licensing': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ipr.IprLicenseTypeName']"}),
        ...
        u'ipr.iprdisclosurebase': {
            ...
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ipr.IprDisclosureStateName']"}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        u'ipr.iprdisclosurestatename': {
        ...
        u'ipr.iprdocrel': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'revisions': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
        ...
        u'ipr.iprevent': {
            ...
            'disclosure': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ipr.IprDisclosureBase']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'msg': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['message.Message']", 'null': 'True', 'blank': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ipr.IprEventTypeName']"})
        },
        u'ipr.ipreventtypename': {
