...
urlpatterns += patterns('',
     ...
     (r'^search_ballot/$', views.search_ballot),
     (r'^ballot/$', views.view_ballot),
     (r'^ballot_comment/$', views.ballot_comment),
     (r'^send_ballot_comment/$', views.send_ballot_comment),
     (r'^send_ballot_comment_to_iesg/$', views.send_ballot_comment_to_iesg),
     (r'^position/$', views.position),
     (r'^(?P<object_id>\d+)/$', views.redirect_id),
     (r'^(?P<slug>[^/]+)/$', views.view_id, dict(id_dict, slug_field='draft__filename')),
     (r'^resurrect/(?P<slug>[^/]+)/$', views.resurrect_id, dict(id_dict, slug_field='draft__filename')),
