...
from ietf.idtracker.models import Area, AreaStatus, IETFWG, WGChair
...
def wg_summary_acronym(request):
    ...
    return HttpResponse(loader.render_to_string('wginfo/summary-by-acronym.txt', {'area_list': areas, 'wg_list': wgs}),mimetype='text/plain')
