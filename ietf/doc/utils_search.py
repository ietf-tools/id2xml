...
def fill_in_document_table_attributes(docs, have_telechat_date=False):
    ...
    # TODO - this function evolved from something that assumed it was handling only drafts. It still has places where it assumes draft where it's not a correct assumption
