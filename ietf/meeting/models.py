...
class SchedTimeSessAssignment(models.Model):
    ...
    extendedfrom = models.ForeignKey('SchedTimeSessAssignment', null=True, default=None, help_text=u"Timeslot this session is an extension of.")
    modified = models.DateTimeField(default=datetime.datetime.now)
    ...
    class Meta:
        ...
        db_table = 'meeting_scheduledsession'
