...
def agenda_by_type(request,num=None,type=None):
    ...
    return render(request,"meeting/agenda_by_type.html",{"meeting":meeting,"scheduledsessions":assignments})
...
def room_view(request, num=None):
    ...
    return render(request, template,{"meeting":meeting,"unavailable":unavailable,"scheduledsessions":assignments,"rooms":rooms,"days":days})
