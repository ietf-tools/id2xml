...
#FIELD_NAMES = ('name', 'meeting', 'requested_prim_start_time', 'requested_alt_start_time', 'requested_duration', 'sidemeeting_type', 'attendance', 'resources', 'comments')
...
FIELD_NAMES['area'] = _("IETF meeting area")
FIELD_NAMES['attendance'] = _("Expected Attendance ")
...
DETAIL_NAMES['area'] = _("IETF meeting area")
DETAIL_NAMES['attendance'] = _("Expected Attendance ")
