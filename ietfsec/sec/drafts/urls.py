...
urlpatterns = patterns('',
    ...
    url(r'^approvals/$', 'sec.drafts.views.approvals', name='drafts_approvals'),
    ...
    url(r'^(?P<id>\d{1,6})/author_delete/$', 'sec.drafts.views.author_delete', name='drafts_author_delete'),
