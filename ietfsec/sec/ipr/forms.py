...
from sec.ipr.models import IprDetail, IprContact, LICENSE_CHOICES, IprRfc, IprDraft, IprUpdate, SELECT_CHOICES
...
class IprDetailForm(BetterModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #self.fields['is_pending'].widget.attrs = 
    ...
    def clean_rfc_num(self):
        return self._fetch_objects(
                self.cleaned_data['rfc_num'].strip(), Rfc)
    ...
    def clean_id_filename(self):
        return self._fetch_objects(
                self.cleaned_data['id_filename'].strip(), InternetDraft)
