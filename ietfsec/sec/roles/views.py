	...
	button_text = request.POST.get('submit', '')
        if button_text.startswith('Update'):
            ...
            for ad in area_directors:
                ...
                history_obj.save()
            messages.success(request, 'The IESG List for IETF %s was updated successfully!' % current_meeting ) 
        ...
        if button_text.startswith('Save'):
            ...
            for ad in area_directors:
                ...
                history_obj.save()
            messages.success(request, 'The IESG List for IETF %s was updated successfully!' % next_meeting )
    ...
    * chairs, type
    ...
    if request.method == 'POST':
		...
		try:
		    ...
		    messages.error(request, 'ERROR: operation failed trying to get current chair.')
		...
		messages.success(request, 'The Chair was added successfully!')
