...
def send_smtp(msg, bcc=None):
    ...
    server = None
    #assert False, (msg.keys(), msg.values()) # msg.to_string()
    try:
        server = smtplib.SMTP()
        if settings.DEBUG:
        ...
        #assert False, (frm, to, msg.as_string())
...
def send_mail_text(request, to, frm, subject, txt, cc=None, extra=None, toUser=None, bcc=None):
    ...
    try:
        ...
        copy_to = "rcross@amsl.com" # % settings.SERVER_MODE
