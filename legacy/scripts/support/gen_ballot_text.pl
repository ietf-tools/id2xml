...
my $url_part = indent_text("Evaluation for $filename_set2 can be found at https://datatracker.ietf.org/$tracker_url.cgi?command=view_id&dTag=$id_document_tag&rfc_flag=$rfc_flag",0);
my $lc_exp_line = "";
