...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AutomaticScheduleStep'
        db.create_table('meeting_automaticschedulestep', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meeting.Schedule'])),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['meeting.Session'], null=True)),
            ('moved_from', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['meeting.ScheduledSession'])),
            ('moved_to', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='+', null=True, to=orm['meeting.ScheduledSession'])),
            ('stepnum', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal('meeting', ['AutomaticScheduleStep'])
    ...
    def backwards(self, orm):
        # Deleting model 'AutomaticScheduleStep'
        db.delete_table('meeting_automaticschedulestep')
    ...
    models = {
        ...
        'meeting.automaticschedulestep': {
            'Meta': {'object_name': 'AutomaticScheduleStep'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'moved_from': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': "orm['meeting.ScheduledSession']"}),
            'moved_to': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'+'", 'null': 'True', 'to': "orm['meeting.ScheduledSession']"}),
            ...
            'stepnum': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        },
        'meeting.constraint': {
