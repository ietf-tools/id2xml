...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.group'
        db.add_column('doc_document', 'group', orm['doc.document:group'])
        
        # Adding field 'Document.stream'
        db.add_column('doc_document', 'stream', orm['doc.document:stream'])
        
        # Adding field 'DocHistory.group'
        db.add_column('doc_dochistory', 'group', orm['doc.dochistory:group'])
        
        # Adding field 'DocHistory.stream'
        db.add_column('doc_dochistory', 'stream', orm['doc.dochistory:stream'])
        
        # Deleting field 'Document.doc_stream'
        db.delete_column('doc_document', 'doc_stream_id')
        
        # Deleting field 'DocHistory.doc_stream'
        db.delete_column('doc_dochistory', 'doc_stream_id')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Document.group'
        db.delete_column('doc_document', 'group_id')
        
        # Deleting field 'Document.stream'
        db.delete_column('doc_document', 'stream_id')
        
        # Deleting field 'DocHistory.group'
        db.delete_column('doc_dochistory', 'group_id')
        
        # Deleting field 'DocHistory.stream'
        db.delete_column('doc_dochistory', 'stream_id')
        
        # Adding field 'Document.doc_stream'
        db.add_column('doc_document', 'doc_stream', orm['doc.document:doc_stream'])
        
        # Adding field 'DocHistory.doc_stream'
        db.add_column('doc_dochistory', 'doc_stream', orm['doc.dochistory:doc_stream'])
