...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocHistory.notify'
        db.add_column('doc_dochistory', 'notify', orm['doc.dochistory:notify'])
        
        # Adding field 'Document.notify'
        db.add_column('doc_document', 'notify', orm['doc.document:notify'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'DocHistory.notify'
        db.delete_column('doc_dochistory', 'notify')
        
        # Deleting field 'Document.notify'
        db.delete_column('doc_document', 'notify')
