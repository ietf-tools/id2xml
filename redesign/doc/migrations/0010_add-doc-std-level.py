...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocHistory.std_level'
        db.add_column('doc_dochistory', 'std_level', orm['doc.dochistory:std_level'])
        
        # Adding field 'Document.std_level'
        db.add_column('doc_document', 'std_level', orm['doc.document:std_level'])
        
        # Changing field 'Document.intended_std_level'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['name.IntendedStatusName'], null=True))
        db.alter_column('doc_document', 'intended_std_level_id', orm['doc.document:intended_std_level'])
        
        # Changing field 'DocHistory.intended_std_level'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['name.IntendedStatusName'], null=True))
        db.alter_column('doc_dochistory', 'intended_std_level_id', orm['doc.dochistory:intended_std_level'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'DocHistory.std_level'
        db.delete_column('doc_dochistory', 'std_level_id')
        
        # Deleting field 'Document.std_level'
        db.delete_column('doc_document', 'std_level_id')
        
        # Changing field 'Document.intended_std_level'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['name.StdStatusName'], null=True))
        db.alter_column('doc_document', 'intended_std_level_id', orm['doc.document:intended_std_level'])
    ...
    models = {
        ...
        'doc.dochistory': {
            ...
            'intended_std_level': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['name.IntendedStatusName']", 'null': 'True'}),
            ...
            'std_level': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['name.StdStatusName']", 'null': 'True'}),
