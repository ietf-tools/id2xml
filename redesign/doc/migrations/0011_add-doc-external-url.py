...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DocHistory.external_url'
        db.add_column('doc_dochistory', 'external_url', orm['doc.dochistory:external_url'])
        
        # Adding field 'Document.external_url'
        db.add_column('doc_document', 'external_url', orm['doc.document:external_url'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'DocHistory.external_url'
        db.delete_column('doc_dochistory', 'external_url')
        
        # Deleting field 'Document.external_url'
        db.delete_column('doc_document', 'external_url')
