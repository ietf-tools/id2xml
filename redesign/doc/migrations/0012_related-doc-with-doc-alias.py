...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RelatedDoc.doc_alias'
        db.add_column('doc_relateddoc', 'doc_alias', orm['doc.relateddoc:doc_alias'])
        
        # Deleting field 'RelatedDoc.document'
        db.delete_column('doc_relateddoc', 'document_id')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'RelatedDoc.doc_alias'
        db.delete_column('doc_relateddoc', 'doc_alias_id')
        
        # Adding field 'RelatedDoc.document'
        db.add_column('doc_relateddoc', 'document', orm['doc.relateddoc:document'])
    ...
    models = {
        ...
        'doc.relateddoc': {
            'doc_alias': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doc.DocAlias']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
