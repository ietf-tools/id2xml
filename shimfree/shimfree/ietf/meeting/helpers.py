...
def meeting_updated(meeting):
    ts = max(meeting.timeslot_set.aggregate(Max('modified'))["modified__max"] or datetime.datetime(1990, 1, 1, 12, 0),
             meeting.session_set.aggregate(Max('modified'))["modified__max"] or datetime.datetime(1990, 1, 1, 12, 0))
