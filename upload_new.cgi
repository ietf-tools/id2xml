...
Please go back to <a href=\"upload_new.cgi\">Upload Page</a> and re-submit your draft.<br>
};
...
#PRI CHANGES
                    ...
                    $error_message .= qq{<br>The message is $pri_message
                                       <br>The file handle is $upload_filehandle
                                       <br>The file namew is $fname
                                       <br>The flag is $flag
                                        <br>the wgn is $wgn };    	
                      $error_message .= qq{<br>
Your submission has been cancelled.<br>
<a href="upload_new.cgi">[Back to upload page]</a>
};
                      error_idst ($query,$error_message,0,$ip);
                      exit;
                 }
...
$cutoff_msg
         ...
         <font face="Arial" size="4"><strong>Upload a draft</font></strong></font>
           <form action="upload_new.cgi" method="post" enctype="multipart/form-data">
           <table width="600">
         <tr>
